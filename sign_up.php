...
<body>
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" name="city" id="inputAddress" placeholder="eg:-karkala">
      </div>
      <div class="form-group">
      <label for="inputAddress1">State</label>
      <input type="text" class="form-control" name="state" id="inputAddress" placeholder="eg:-karnataka">
      </div>
      <div class="form-row">
    <div class="form-group">
  ...
  <input type="submit" value="Sign up" name="submit" class="btn btn-dark">
</form>
</div>
</div>
